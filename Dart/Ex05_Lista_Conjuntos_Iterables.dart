void main() {
  ...
  final numeros = [1,2,2,2,2,2,3,4,5,6,6,7,7,7,8,9,10];
...
print("Convertimos el ITERABLE a LISTA usando .toList(): ${numerosAlreves.toList()} y verificamos el tipo de dato: ${numerosAlreves.toList().runtimeType}");
  ...
  print('**********************---------------------------------------**********************');
    ...
    //Un set es una Estructura de datos utilizada por DART que simplifica los elelemntos eliminando sus duplicados 
